...
export default function Dashboard() {
  ...
  async function addTransaction(e: React.FormEvent) {
    ...
    if (!amount || !form.description.trim()) {
    ...
    <main className="dashboardPage">
      <header className="dashHeader">
        <Link href="/" className="brand">
          <span className="brandMark">M</span> Money Clarity
        </Link>
      ...
      <section className="dashContent">
        <div className="dashIntro">
          <div>
            ...
            <p>
              Track income and expenses and see your net position at a glance.
            </p>
          </div>
        </div>
        ...
        <div className="statGrid big">
          <div className="stat">
            ...
            <strong>PKR {stats.revenue.toLocaleString()}</strong>
            <small>All recorded income</small>
          </div>

          <div className="stat">
            <span>Total expenses</span>
            <strong>PKR {stats.expenses.toLocaleString()}</strong>
            <small>All recorded expenses</small>
          </div>

          <div className="stat">
            <span>Net</span>
            <strong>PKR {stats.net.toLocaleString()}</strong>
            <small>
              {stats.net >= 0 ? "Positive balance" : "Needs attention"}
            </small>
          </div>
        </div>
              ...
              <div className="txList">
                {transactions.slice(0, 10).map((t) => (
                  <div className="txRow" key={t.id}>
                    ...
                    <div>
                      <strong
                        className={t.type === "expense" ? "expense" : ""}
                      >
                        {t.type === "expense" ? "−" : "+"} PKR{" "}
